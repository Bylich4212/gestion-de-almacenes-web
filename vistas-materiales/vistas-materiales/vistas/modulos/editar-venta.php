            ...
            <div class="card-body">
              ...
              ?>
                ...
                foreach ($listaProducto as $key => $value) {
                  ...
                  echo '<div class="row" style="padding:0px 7px">
                        ...
                        <div class="col-lg-3 ingresoPrecio">
                        ...
                        <tr>
                          ...
                          <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control form-control-lg" min="0" id="nuevoImpuestoVenta" name="nuevoImpuestoVenta" placeholder="<?php echo $porcentajeImpuesto; ?>" required>
                          ...
                          <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control form-control-lg" id="nuevoTotalVenta" name="nuevoTotalVenta" total="<?php echo $venta["neto"]; ?>" value="<?php echo $venta["total"]; ?>" readonly required>
