...
if(localStorage.getItem("capturarRango") != null){
	...
	$("#daterange-btn span").html('<i class="far fa-calendar-times"></i> Rango de fecha');
...
// VERIFICAR QUE LOS DATOS LLGUEN EN CONSOLA
		...
		url:"ajax/productos.ajax.php",
      	...
      	success:function(respuesta){
          	...
          	'<div class="row m-1">'+
                    ...
                    '<div class="col-3 mb-3 ingresoCantidad">'+
...
$("#nuevoMetodoPago").change(function(){
	...
	if(metodo == "Efectivo"){
		...
		$(this).parent().parent().parent().children('.cajasMetodoPago').html(
			 ...
			 '<div class="col-lg-6" id="capturarCambioEfectivo">'+
		...
		$(this).parent().parent().parent().children('.cajasMetodoPago').html( 
			...
			'<div class="col-lg-6">'+
			 ...
			 '<label>Ingresa el Código de Transacción: </label>' +
...
// ON -> LA ENTRADA APARECE DESPUES DE ELEGIR ALGO DEL SELECT
